...
app.layout = html.Div([
    ...
    dcc.Tabs([
        # Tab 1 - Replicated Graphs
        dcc.Tab(label="Replicated Graphs", children=[
            html.H2("Replicated Graphs", style={'text-align': 'center'}),
            ...
            html.Div([
                ...
                html.P("This plot shows the growth of EVs in a few different regions, but most interestingly shows the split between full-battery EVs (shown as BEV in the plot) and plug-in hybrids, which often run on both electricity and petrol."
                " The full-battery EVs are more popular in all regions when compared to the hybrids. In most places the full-battery EVs are twice as popular"
                "(making up 12% of sales globally in 2023, vs 6% for the hybrids."
            ...
            html.Div([
                ...
                html.P("European countries such as Norway, Sweden and the United Kingdom saw noticeable declines or stagnation in the share of new,"
                " fully battery-electric cars sold between 2015 - 2017. Afterwards, the share of these vehicles sold began to increase."
        ...
        dcc.Tab(label='Unique Visuals', children=[
            ...
            html.Div([
                ...
                " For countries like Norway, this shows that they have a lot of EVs on the road already and the market may be becoming saturated for EVs."
                " In comparison, countries like Brazil, India, or Australia that have a lower ratio indicate that the country is selling a lot of EVs but does not have many EVs on the road as of the most recent year."
                " These countries could indicate a hot or up-and-coming market for EV sales."),
        ...
        dcc.Tab(label='XGBoost', children=[
            html.H2("XGBoost Model Predictions vs Actual Sales", style = {'text-align':'center'}),
